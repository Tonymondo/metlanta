...
const SOCIAL = [
  {
    label: 'Instagram',
    href: 'https://instagram.com/metlanta',
    icon: (
  ...
  {
    label: 'TikTok',
    href: 'https://tiktok.com/@metlanta',
    icon: (
      <svg width="17" height="17" viewBox="0 0 24 24" fill="currentColor">
  ...
  return (
    ...
    >
      <div className="section-wrapper py-16 lg:py-20">
        <div className="grid grid-cols-2 md:grid-cols-6 gap-10 lg:gap-16 mb-14">
          {/* Brand */}
          <div className="col-span-2">
            <Logo size="sm" className="mb-4" />
            <p className="text-sm leading-relaxed max-w-[210px] mb-6" style={{ color: '#555' }}>
              ...
              {SOCIAL.map((s) => (
                <a
                  ...
                  onMouseEnter={(e) => {
                    ...
                    e.currentTarget.style.borderColor = 'rgba(224,48,48,0.25)'
                    e.currentTarget.style.background = 'rgba(224,48,48,0.06)'
                  }}
                  onMouseLeave={(e) => {
          ...
          {Object.entries(LINKS).map(([category, links]) => (
            <div key={category}>
              <div className="text-[9px] font-bold uppercase tracking-[2.5px] mb-4" style={{ color: '#333' }}>
                {category}
              </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs" style={{ color: '#333' }}>
            © 2026 Metlanta, Inc. All rights reserved. Built in Atlanta, GA.
          </p>
